      ...
      <div class="jc-demo-box">
        ...
        <!-------------------------------------------->
              ...
              {?>
                ...
                <img src="../../images/equipe/<?=$_GET['image']?>" width="400"/>
                <?php
              }
        ...
        <!-------------------------------------------->
          ...
          <div class="col-lg-6">
            ...
            if (isset($_FILES['photo']['tmp_name']))
            {
              $extension = strtolower(strrchr($_FILES['photo']['name'], '.'));
                ...
                else
                {
                  ...
                  ?>
                  <img src="../../img/home/course/<?=$_GET['image']?>"/>
                  <form method="post" enctype="multipart/form-data">
                      <input type="file" name="photo" required>       
            ...
            if(isset($_POST['image']))
            {
               //$nomImage=$_GET['id'].'_cont_'.$_POST['nom'];     
              ...
              imagejpeg($im_php, '../../images/equipe/'.$_POST['nom'], 90);
              echo '<img src="../../images/equipe/'.$_POST['nom'].'" width="400">
              <p></p>
              <a href="../controller/controller-equipe.php?form=ajouterPhoto&id='.$id.'&photo='.$_POST['nom'].'" class="btn btn-primary btn-icon-split btn-sm">
