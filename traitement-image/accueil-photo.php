...
//On va chercher l'image dans le dossier avec le nom en base de données
                ...
                <img src="../../images/slides/<?=$_GET['image']?>" width="400"/>
                <?php
              }
        ...
        <!-------------------------------------------->
          ...
          <div class="col-lg-6">
            ...
            if (isset($_FILES['photo']['tmp_name']))
            {
              $extension = strtolower(strrchr($_FILES['photo']['name'], '.'));
                ...
                if ($extension == '.jpg' || $extension == '.jpeg')
                {
                  ...
                  imagejpeg($im_miniature, 'temporaire/'.$_FILES['photo']['name'], 100);
                ...
                else
                {
                  ...
                  ?>
                  <img src="../../images/slides/<?=$_GET['image']?>"/>
                  <form method="post" enctype="multipart/form-data">
                      <input type="file" name="photo" required>       
            ...
            if(isset($_POST['image']))
            {
              ...
              imagejpeg($im_php, '../../images/slides/'.$_POST['nom'], 90);
              echo '<img src="../../images/slides/'.$_POST['nom'].'" width="400">
              <p></p>
              <a href="../controller/controller-accueil.php?form=ajouterPhoto&id='.$id.'&photo='.$_POST['nom'].'" class="btn btn-primary btn-icon-split btn-sm">
