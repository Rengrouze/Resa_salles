...
<div class="container-fluid d-flex flex-row mx-auto mt-2 mb-4 ">
                ...
                <table class="calendar__table calendar__table--<?= $weeks; ?>weeks">
                    ...
                    <tr>
                        <?php foreach ($month->days as $k => $day):
                                     ...
                                     ?>
                        <td
                            class="<?= $date->format('Y-m-d'); ?> <?= $isaPastDayFromToday ? 'past-day' : '' ?> <?= $month->withinMonth($date) ? '' : 'calendar__overmonth'; ?> <?= $isToday ? 'is-today' : ''; ?> <?= $isBusy ? 'is-busy' : ''; ?> <?= $isBusyTemp ? 'is-busy-temp' : ''; ?><?= $isBottomLeft ? 'corner-bottom-left' : ''; ?> <?= $isBottomRight ? 'corner-bottom-right' : ''; ?> calendar-date">
                            <div
    ...
    <!-- mobile section  un peu buggué -->
    <div id="mobile-section-validate"
        class="d-md-none bg-dark fixed-bottom animate__animated animate__fadeIn animate_animated-fadeOut d-none"
        style="height : 35vh">
