        ...
        <header class="app-header app-header-dark">
            ...
            <div class="top-bar">
                ...
                <div class="top-bar-brand">
                    ...
                    <a href="index.php"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <li class="nav-item dropdown header-nav-dropdown has-notified">
                                ...
                                <div class="dropdown-menu dropdown-menu-rich dropdown-menu-right">
                                    ...
                                    <h6 class="dropdown-header stop-propagation">
                                        <span>Activities <span class="badge">(TODO PHP)</span></span>
                                    </h6><!-- .dropdown-scroll -->
                                ...
                                <div class="dropdown-menu dropdown-menu-rich dropdown-menu-right">
                                    ...
                                    <div class="dropdown-sheets">
                                        ...
                                        <div class="dropdown-sheet-item">
                                            <a href="clients.php" class="tile-wrapper"><span
                                                    class="tile tile-lg bg-indigo"><i class="oi oi-people"></i></span>
                                                <span class="tile-peek">Clients</span></a>
                                        </div><!-- /.dropdown-sheet-item -->
                                        <!-- .dropdown-sheet-item -->
                                        <div class="dropdown-sheet-item">
                                            <a href="rooms.php" class="tile-wrapper"><span
                                                    class="tile tile-lg bg-teal"><i class="oi oi-fork"></i></span> <span
                                                    class="tile-peek">Salles</span></a>
                                        </div><!-- /.dropdown-sheet-item -->
                                        <!-- .dropdown-sheet-item -->
                                        <div class="dropdown-sheet-item">
                                            <a href="bookings.php" class="tile-wrapper"><span
                                                    class="tile tile-lg bg-pink"><i class="fa fa-tasks"></i></span>
                                                <span class="tile-peek">Reservations</span></a>
                                        </div><!-- /.dropdown-sheet-item -->
                                        <!-- .dropdown-sheet-item -->
                                        <div class="dropdown-sheet-item">
                                            <a href="calendar.php" class="tile-wrapper"><span
                                                    class="tile tile-lg bg-yellow"><i class="oi oi-fire"></i></span>
                                                <span class="tile-peek">Calendrier</span></a>
                                        </div><!-- /.dropdown-sheet-item -->
                                        <!-- .dropdown-sheet-item 
                                        <div class="dropdown-sheet-item">
                        ...
                        <div class="dropdown d-none d-md-flex">
                            <button class="btn-account" type="button" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false"><span class="user-avatar user-avatar-md"><img
                                    ...
                                    class="account-summary pr-lg-4 d-none d-lg-block"><span class="account-name">TODO :
                                        ADMIN NAME</span> <span class="account-description"> MODE ADMIN
                            ...
                            <div class="dropdown-menu">
                                ...
                                <h6 class="dropdown-header d-none d-md-block d-lg-none"> Beni Arisandi </h6><a
                                    class="dropdown-item" href="user-profile.html"><span
                                        class="dropdown-icon oi oi-person"></span> Profil</a> <a class="dropdown-item"
                ...
                <header class="aside-header d-block d-md-none">
                    ...
                    <button class="btn-account" type="button" data-toggle="collapse" data-target="#dropdown-aside"><span
                            class="user-avatar user-avatar-lg"><img src="assets/images/avatars/profile.jpg"
                                ...
                                class="account-name">TODO : ADMIN NAME</span> <span class="account-description">MODE
                                ADMIN</span></span></button> <!-- /.btn-account -->
                    <!-- .dropdown-aside -->
