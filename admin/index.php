...
require '../src/adminSession.php';
 render_admin('header', ['title' => 'Admin', 'script' => 'index.js']);
...
$numberOfClients = $clients->countClients();
$numberOfRooms = $rooms->countRooms();
$numberOfUnvalidatedEvents = $events->countUnvalidatedEvents();
// number of Client is an array, convert it to an integer
            ...
            <div class="page-inner">
                ...
                <header class="page-title-bar">
                    <div class="d-flex flex-column flex-md-row">
                        <p class="lead">
                            <span class="font-weight-bold">Hi, Beni.</span> <span class="d-block text-muted">Here’s
                                    ...
                                    <div class="col">
                                        ...
                                        <a href="user-teams.html" class="metric metric-bordered align-items-center">
                                            ...
                                            <p class="metric-value h3">
                                                ...
                                                <sub><i class="oi oi-people"></i></sub> <span class="value"><?= $numberOfClients ?></span>
                                            </p>
                                        </a> <!-- /.metric -->
                                    </div><!-- /metric column -->
                                    <!-- metric column -->
                                ...
                                <a href="user-tasks.html" class="metric metric-bordered">
                                    <div class="metric-badge">
                                        <span class="badge badge-lg badge-success"><span
                                                class="oi oi-media-record pulse mr-1"></span> ONGOING TASKS</span>
                                    </div>
                                    <p class="metric-value h3">
                        ...
                        <div class="card card-fluid pb-3">
                            ...
                            <div class="lits-group list-group-flush">
                                    ...
                                    <div class="list-group-item-figure">
                                        <div class="has-badge">
                                            <a href="page-project.html" class="tile tile-md bg-yellow">OS</a> <a
                                                href="#team" class="user-avatar user-avatar-xs"><img
                                                    src="assets/images/avatars/team2.png" alt=""></a>
                                        </div>
                                    </div><!-- .lits-group-item-figure -->
                                    <!-- .lits-group-item-body -->
                                    <div class="list-group-item-body">
                                ...
                                <div class="list-group-item">
                                    ...
                                    <div class="list-group-item-figure">
                                        <div class="has-badge">
                                            <a href="page-project.html" class="tile tile-md bg-blue">BA</a> <a
                                                href="#team" class="user-avatar user-avatar-xs"><img
                                ...
                                <div class="list-group-item">
                                    ...
                                    <div class="list-group-item-figure">
                                        <div class="has-badge">
                                            <a href="page-project.html" class="tile tile-md bg-teal">SB</a> <a
                                                href="#team" class="user-avatar user-avatar-xs"><img
                                                    src="assets/images/avatars/sketch.svg" alt=""></a>
                                        </div>
                                    </div><!-- .lits-group-item-figure -->
                                    <!-- .lits-group-item-body -->
                                    <div class="list-group-item-body">
                                ...
                                <div class="list-group-item">
                                    ...
                                    <div class="list-group-item-figure">
                                        <div class="has-badge">
                                            <a href="page-project.html" class="tile tile-md bg-pink">SP</a> <a
                                                href="#team" class="user-avatar user-avatar-xs"><img
                                                    src="assets/images/avatars/team4.jpg" alt=""></a>
                                        </div>
                                    </div><!-- .lits-group-item-figure -->
                                ...
                                <div class="todo-list">
                                    ...
                                    <div class="todo">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="todo2">Mix up a pitcher of
                                                sangria</label>
                                        </div><!-- /.custom-control -->
                                    </div><!-- /.todo -->
                                    <!-- .todo -->
